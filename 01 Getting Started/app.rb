...
class GiftBasket < Sinatra::Base
  ...
  APP_URL = "http://314ac54e.ngrok.io"
  ...
  get '/giftbasket/install' do
    ...
    install_url = "http://314ac54e.ngrok.io/admin/oauth/authorize?client_id=#{API_KEY}"\
  ...
  helpers do
    def get_shop_access_token(shop,client_id,client_secret,code)
      if @tokens[shop].nil?
        url = "https://314ac54e.ngrok.io/admin/oauth/access_token"
